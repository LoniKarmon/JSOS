    ...
    CipherSuite: TlsCipherSuite,
{
    ...
    pub(crate) alpn_protocols: Option<heapless::Vec<&'a [u8], 4>>,
}
    ...
    CipherSuite: TlsCipherSuite,
{
    ...
    pub fn with_alpn_protocols(mut self, protocols: &[&'a [u8]]) -> Self {
        self.alpn_protocols = Some(unwrap!(Vec::from_slice(protocols).ok()));
        self
    }
}
